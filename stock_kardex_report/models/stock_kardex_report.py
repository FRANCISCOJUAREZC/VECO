...
class StockKardexReport(models.Model):
    ...
    qty_done = fields.Integer('Cantidad hecha', readonly=True)
    ...
    initial_balance = fields.Integer(string="Balance inicial", readonly=True)
    balance = fields.Integer(string="Balance final", readonly=True)
