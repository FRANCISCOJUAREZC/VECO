    ...
    def _l10n_mx_edi_get_invoice_cfdi_values(self, invoice):
        ...
        if invoice.l10n_mx_edi_external_trade:
            ...
            for product, line_vals_list in invoice_lines_gb_products.items():
                ...
                price_unit_usd = float_round(price_unit_usd, precision_digits=6)
                ...
                line_total_usd = float_round(line_total_usd, precision_digits=4)
                    ...
                    if line_vals['line'].info_mercancias.cce_series:
                        for serie in line_vals['line'].info_mercancias.cce_series:
                            desc_especifica.append({
                               ...
                               'NumeroSerie': line_vals['line'].cce_numeroserie,
                            })
...
#                        raise UserError(_('No son iguales el número de series registradas en Información mercancia que la cantidad de productos registrados en aduana'))
            ...
            _logger.info('ext_trade_goods_details %s', ext_trade_goods_details)
